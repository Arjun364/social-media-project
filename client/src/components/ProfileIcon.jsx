...
const ProfileIcon = ({ isSection }) => {
    ...
    return (
        <div className='relative'>
            {/* profile icon */}
            <Avatar img={`${serverUrl}/${userimg}` || avatar} className='cursor-pointer object-cover' rounded status="online" statusPosition="bottom-right" onClick={() => setDropDown(!dropdown)} />
            {/* profile menu */}
